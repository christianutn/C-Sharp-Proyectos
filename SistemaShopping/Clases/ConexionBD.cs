...
namespace SistemaShopping.Clases
{
        ...
        internal class conexionBD
        {
            ...
            string cadenaConexion = "Data Source=DESKTOP-J78AN4H\\SQLEXPRESS;Initial Catalog=SistemaShopping;Integrated Security=True";
            ...
            public DataTable EjecutarSelect(string sql)
            {
             ...
             public string EjecutarSelect(string sql, params string[] list)
        {
            Conectar();
            ...
            {
                cont++;
                if (cont == 1 || cont % 2 != 0) // es impar
                {
                    cmd.Parameters.AddWithValue(list[i], list[i + 1]);
                }
            }
            ...
            try
            {
                return cmd.ExecuteNonQuery().ToString(); // Punto donde se puede generar un error
            ...
            Desconectar();
            return resultado; // Si la transaccion da error se devuelve la tabla vacía
