...
namespace SistemaShopping.Formularios.Clientes
{
    public partial class FrmEliminarCliente : Form
    {
        ...
        {
            string codTipoDoc = cmbTipoDoc.SelectedValue.ToString();
            string numeroDoc = txtNroDoc.Text;

            if (NegocioUsuario.EliminarCliente(codTipoDoc, numeroDoc) == NegocioUsuario.Resultado.correcto)
            {
